...
const OurJourney = () => {
    return (
        <div> <h2 className="text-4xl font-bold font-serif mb-1 pt-8	text-center">Our journey</h2>
         ...
         <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThKLy-P755sjjB1xGzuw79YjA8zqQyPcL5Q8jITx8Q-nRBYN3ASJslLLriGd2BaqX8tzg&usqp=CAU" alt="Album" className='w-1/2' />            <div className="card-body">
